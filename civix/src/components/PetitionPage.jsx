...
const PetitionPage = () => {
  ...
  // Load petitions from localStorage
  useEffect(() => {
    const loadPetitions = () => {
    ...
    window.addEventListener('petitionsUpdated', handleStorageChange);

    return () => {
      window.removeEventListener('storage', handleStorageChange);
      window.removeEventListener('petitionsUpdated', handleStorageChange);
    };
  }, []);
